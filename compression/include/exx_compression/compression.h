...
public:
	...
	void rotateToAxis(	const Eigen::Vector3d normal, std::vector<PointCloudT::Ptr>  &planes, std::vector<Eigen::Vector4d>  &normal_vec, PointCloudT::Ptr nonPlanar);
	void rotateToAxis(	std::vector<PointCloudT::Ptr> &planes, std::vector<Eigen::Vector4d> &normal_vec, PointCloudT::Ptr nonPlanar);
